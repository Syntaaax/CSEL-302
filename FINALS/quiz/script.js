...
function showQuetions(index){
    ...
    imageElement.style.position = canvas;
    ...
    + '<div class="option"><span>'+ questions[index].options[3] +'</span></div>';
     ...
     // Update the HTML of que_text and option_list elements
     que_text.innerHTML = '';
     que_text.appendChild(imageContainer);
     que_text.insertAdjacentHTML('beforeend', que_tag);
     option_list.innerHTML = option_tag;

     // Add onclick attribute to all available options
